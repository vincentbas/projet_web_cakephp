...
<div id="seances" class="container">
 ...
 ?>
    ...
    <td class="td_change">
    <?php echo "<li><p>".$this->Form->postLink(__('SUPP'), ['action' => 'delete', $w['id']], ['confirm' => __('Êtes vous sur de vouloir supprimer la seance  # {0}?', $w['id'])])."</p></li>"; ?></td>
...
'class'=>'glyphicon glyphicon-remove'    <div class="modal-content">
